...
`~/.jira_token` present for attachments · `gh auth status` logged in · Node ≥ 22 (`nvm use`) and
...
matrix and recipes. For this repo the default is **npm** (Node ≥ 22) to build the UI and **Docker** for
