...
```
~/Desktop/jira-evidence/<TICKET-ID>/validation/
  Evidence/
...
```js
// ~/Desktop/jira-evidence/WEBUI-1234/validation/harness/after.js
...
```bash
. ~/Desktop/jira-evidence/WEBUI-1234/validation/env.sh
