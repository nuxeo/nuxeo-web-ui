...
themes/
  ...
  kawaii/          → Kawaii demo theme (same structure, plus background.png)
...
- Test changes against all 6 themes (default (Nuxeo), dark, kawaii, light, hyland-light, hyland-dark)
