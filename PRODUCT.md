...
Six visual themes are bundled, offered as two sets according to the branding opt-in:

- **Nuxeo** — Standard Nuxeo branding (the default)
- **Dark** — Dark mode interface
- **Kawaii** — Deliberately unconventional; demonstrates the breadth of theming possible
- **Light** — Lighter alternative to the Nuxeo theme
