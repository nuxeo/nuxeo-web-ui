 ...
 * @memberof Nuxeo
 */
class AIExportProgress extends Polymer.mixinBehaviors(
  [Nuxeo.I18nBehavior, Polymer.IronFormElementBehavior],
  Nuxeo.Element,
) {
  static get template() {
    return html`
      ...
      <div class="progress">
        ...
        <div class="page">
          <div class="widget main">
            ...
            <p class="progress_counter">[[_processed]]/[[_total]] documents</p>
          </div>
  ...
  _processedUpdated(newVal) {
    ...
    this._progress = (newVal * 100) / this._total;
  }
