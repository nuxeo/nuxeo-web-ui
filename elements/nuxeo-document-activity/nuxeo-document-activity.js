...
Polymer({
  ...
  _areGatherableActivities(a, b) {
    ...
    return a.extended && a.extended.clientReason && b.extended && b.extended.clientReason
      ? a.extended.clientReason === 'view'
      : a.eventId === 'download' && a.principalName === b.principalName && delta < 24;
  },
});
