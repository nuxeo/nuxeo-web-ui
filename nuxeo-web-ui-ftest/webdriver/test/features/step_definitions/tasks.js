...
module.exports = function () {
  ...
  this.Then('I can see the View Tasks Dashboard link', () => this.ui.tasksLink.isVisible().should.be.true);
  this.When('I click the View Tasks Dashboard link', () => this.ui.tasksLink.click());
