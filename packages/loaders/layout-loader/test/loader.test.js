...
describe('loader', () => {
  it('should work with field layouts', async () => {
    const stats = await compile('fixtures/layouts/field-layout');
    ...
    expect(path.join(__dirname, module.name)).to.equal(path.join(__dirname, 'fixtures/layouts/field-layout.yaml'));
