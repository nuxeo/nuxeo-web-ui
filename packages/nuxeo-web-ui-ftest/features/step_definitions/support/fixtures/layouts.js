...
global.fieldRegistry.register(
  'nuxeo-date-picker',
  (element) =>
    moment(element.element('vaadin-date-picker-text-field').getValue(), global.dateFormat).format(global.dateFormat),
  (element, value) => {
    const date = element.element('vaadin-date-picker-text-field');
    if (date.getValue()) {
