...
suite('nuxeo-document-parent-inspector-button', () => {
  ...
  suite('Parent Inspector', () => {
    ...
    test(
      'Should display title, UID, path, schemas and facets in parent inspector dialog if user is administrator',
      async () => {
        const document = {
          'entity-type': 'document',
          contextParameters: {
    ...
    test(
      'Should display title, path and facets and hide uid and schemas' +
        ' in parent inspector dialog if user is not administrator',
      async () => {
        const document = {
          'entity-type': 'document',
          contextParameters: {
